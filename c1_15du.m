%% 1. Load Data
filename = '/MATLAB Drive/Main_Mya/1c 15du new.xlsx';
data = readtable(filename);
modelSavePath = '/MATLAB Drive/Main_Mya/c1_15du_new_Models/';
imageSavePath = '/MATLAB Drive/Main_Mya/c1_15du_new_Images/';
